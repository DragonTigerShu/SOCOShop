    ...
    <div class="wrapper">
      ...
      <div class="app-header">
        <div class="app-header-inner">
          ...
          <a href="http://www.supersoco.com/second-phase/ch/index.php">
            <img class="header-img" src="./common/images/login/logo.png"/>
          </a>
          <nav class="nav vertical">     
            <a href="http://www.supersoco.com/second-phase/ch/index.php">SOCO电动</a>
      ...
      <div class="app-content">
        <router-view :reload="reload" :menuNext="menuNext"  :reloadCart="reloadCart"  @appListen="appListen"></router-view>
      </div>
